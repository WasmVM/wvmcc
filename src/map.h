...
// mapInsert: If key doesn't exist, insert it, or free the existed data and set the data for this existed key
void mapInsert(Map *thisMap, void* key, void* data);
// mapRemove: Remove and free the key and value. Return 0 on success, or return -1 if not exist
