...
Suite pp_directive {
    Category("define", {
        Test("object-like", {
            ...
            Expect(pp.macros.contains("foo"));
            Expect(pp.macros["foo"].replacement.size() == 6);
            Expect(!pp.macros["foo"].params);
        })
        Test("no-parameter", {
            ...
            Expect(pp.macros["foo"].replacement.size() == 6);
            Expect(pp.macros["foo"].params);
            Expect(pp.macros["foo"].params->size() == 0);
        })
        Test("one-parameter", {
            ...
            Expect(pp.macros["foo"].replacement.size() == 6);
            Expect(pp.macros["foo"].params);
            Expect(pp.macros["foo"].params->size() == 1);
        })
        Test("more-parameter", {
            ...
            Expect(pp.macros["foo"].replacement.size() == 6);
            Expect(pp.macros["foo"].params);
            Expect(pp.macros["foo"].params->size() == 2);
        })
        Test("variable", {
            ...
            Expect(pp.macros["foo"].params);
            Expect(pp.macros["foo"].params->size() == 1);
            Expect(pp.macros["foo"].params->back() == "...");
        })
        Test("variable-parameter", {
            ...
            Expect(pp.macros["foo"].replacement.size() == 6);
            Expect(pp.macros["foo"].params);
            Expect(pp.macros["foo"].params->size() == 3);
            Expect(pp.macros["foo"].params->back() == "...");
        })
